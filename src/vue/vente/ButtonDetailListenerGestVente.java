 ...
 * @author VEK
 */
public class ButtonDetailListenerGestVente implements ActionListener{
    /* jai 2 listener un pour le gest et l'autre pour l'admin car la localisation 
    de l'idvente est differente
    */
